...
public class StandAloneTestpractice {
	...
	public static void main(String[] args) {
		...
		WebElement expiryDateDropdown=driver.findElement(By.xpath("(//select[@class='input ddl'])[1]"));
		Select dropdownexpirymonth=new Select(expiryDateDropdown);
		dropdownexpirymonth.selectByIndex(4);
